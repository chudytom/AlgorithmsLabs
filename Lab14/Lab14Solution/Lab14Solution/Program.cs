...
namespace ASD
{
    ...
    class Lab14TestModule : TestModule
    {
        public override void PrepareTestSets()
        {
            ...
            string DecodingTests = "DecodingTests";
            TestSets[DecodingTests] = new TestSet(solver, "Decoding correctness tests");
            ...
            string DecodingTestsPerformance = "DecodingTestsPerformance";
            TestSets[DecodingTestsPerformance] = new TestSet(solver, "Decoding performance tests");
            ...
            TestSets[Correctness] = new TestSet(solver, "Encoding correctness tests");
            ...
            TestSets[Performance] = new TestSet(solver, "Basic encoding performance tests");
    ...
    class EncodingTestCase : TestCase
    {
        ...
        public override void VerifyTestCase(out Result resultCode, out string message, object settings)
        {
            ...
            for (int i = 0; i < result.Count; i++)
            {
                ...
                {
                    resultCode = Result.BadResult;
                    message = "Error: result[" + i.ToString() + "].p=" + result[i].p.ToString() + ", should be at most " + resLen.ToString();
                    return;
                }
                if (result[i].c < 0)
                {
